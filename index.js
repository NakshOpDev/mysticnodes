...
const naksh = readline.createInterface({
  input: process.stdin,
...
console.log(`
 ...
 █░▀░█ ░█░ ▄█ ░█░ █ █▄▄ █░▀█ █▄█ █▄▀ ██▄ ▄█      
    ...
    Best Hosting => Mystic Nodes
    Tool Owner => Naksh
    Hosting Owner => Naksh And Manvir
    Discord => discord.gg/mysticnodes
...
async function bootup() {
  try {
    ...
    console.log(`|| [======>      ] || 20%`);
    const getLatestVersion = await fetch('https://raw.githubusercontent.com/NakshOpDev/mysticnodes/main/version.txt');
    const latestVersion = await getLatestVersion.text()
    console.log(`|| [===========>        ] || 30%`);
    if (version === latestVersion.trim()) {
    console.log(`|| [==============>     ]|| 60%`);
    
    const secretBangetJir = await fetch('https://raw.githubusercontent.com/NakshOpDev/mysticnodes/main/sigma.txt');
    const password = await secretBangetJir.text();
    await console.log(`Login Password Required`)
    naksh.question('[\x1b[1m\x1b[31mNaksh Security\x1b[0m]: \n', async (skibidi) => {
...
Type exit To Stop
`);
naksh.question('[\x1b[1m\x1b[31mNaksh Wifi Killer\x1b[0m]: \n', async (yakin) => {
if (yakin === 'exit') {
...
naksh.question('[\x1b[1m\x1b[31mNaksh Chat AI\x1b[0m]: \n', async (yakin) => {
if (yakin === 'exit') {
...
const getNews = await fetch(`https://raw.githubusercontent.com/nakshmd/cache/main/news.txt`)
const latestNews = await getNews.text();
const creatorCredits = `
Created And Coded Full By Naksh
...
Mystic Nodes
`
naksh.question('[\x1b[1m\x1b[32mMystic Nodes\x1b[0m]: \n', (input) => {
...
${creatorCredits}`);
    ...
    console.log(`Naksh Ai Ragbot Started
